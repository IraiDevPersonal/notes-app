  ...
  return (
    <>
      <aside
        ...
        aria-label="Sidebar"
        className={cn(
          "xs:min-w-72 xs:w-72 w-full h-dvh py-8 px-6 bg-box fixed md:relative top-0 left-0 z-30 transition-all duration-300 -translate-x-full data-[open=true]:translate-x-0 md:translate-x-0 border-r border-transparent md:border-transparent xs:border-border"
        )}
      >
