...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2 py-1.5 text-xs italic text-muted-foreground font-normal data-[inset]:pl-8",
        className
      )}
      {...props}
    />
